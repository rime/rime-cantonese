...
wget https://github.com/tanxpyox/7z.sfx-backup/raw/master/7zS2.sfx
7z a windows-installer.7z ./build/windows/*
7z a output/windows-${TRAVIS_TAG}-installer.zip ./build/windows/*
cat 7zS2.sfx .ci/config.txt windows-installer.7z > output/windows-sfx-${TRAVIS_TAG}-installer.exe
