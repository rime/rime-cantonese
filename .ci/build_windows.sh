...
wget https://github.com/tanxpyox/7z.sfx-backup/raw/master/7zSD.sfx
7z a windows-installer.7z ./build/windows/*
cat 7zSD.sfx .ci/config.txt windows-installer.7z > output/windows-${TRAVIS_TAG}-installer.exe
